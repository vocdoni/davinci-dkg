...
const (
	dkgManagerABIJSON = `[
		...
		{"inputs":[],"name":"POOL_KEY_VERIFIER","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},
		...
		{"inputs":[],"name":"getPoolKeyVerifierVKeyHash","outputs":[{"internalType":"bytes32","name":"","type":"bytes32"}],"stateMutability":"view","type":"function"},
	...
	dkgRegistryABIJSON = `[
		{"inputs":[{"internalType":"address","name":"operator","type":"address"}],"name":"getNode","outputs":[{"name":"operator","type":"address"},{"name":"pubX","type":"uint256"},{"name":"pubY","type":"uint256"},{"name":"status","type":"uint8"},{"name":"lastActiveBlock","type":"uint64"},{"name":"registeredAtBlock","type":"uint64"}],"stateMutability":"view","type":"function"}
	]`
)
...
func New(rpcURLs []string, addresses types.ContractAddresses) (*Contracts, error) {
	...
	verifierFields := []struct {
		...
		{"POOL_KEY_VERIFIER", &addresses.PoolKeyVerifier},
